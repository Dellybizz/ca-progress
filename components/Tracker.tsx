...
const menu: { label: View; icon: typeof Home }[] = [
  ...
  { label: "Chapters", icon: NotebookPen },
  { label: "Analytics", icon: LineChart },
  { label: "Study Sessions", icon: Clock3 },
...
const subjectMeta: Record<
  SubjectName,
  { code: string; color: string; short: string }
> = {
  "Advanced Accounting": {
    code: "AA",
    color: "#5b6fd6",
...
export default function Tracker() {
  ...
  const [activeSubject, setActiveSubject] =
    useState<SubjectName>(subjects[0]);
  ...
  const subjectStats = (subject: SubjectName) => {
    ...
    const done = chapters.filter(
      (chapter) =>
        progress[keyFor(subject, chapter)]?.done
    ).length;
    ...
    <main className="app-shell">
      ...
      >
        ...
        <button
          ...
          onClick={() =>
            flash("Profile settings coming next")
          }
        >
...
function Dashboard({
  ...
  const recent = activities.length
    ...
    <>
      <div className="dashboard-head">
        <div className="exam-card">
          ...
          <div>
            <small>CA INTERMEDIATE EXAM</small>
    ...
    <section className="chapters-page">
      <div className="chapter-top">
        <div>
          ...
          <h2>
            {subjectMeta[activeSubject].short}
          </h2>
          ...
          <div className="chapter-progress">
            <span
              style={{
                width: `${
                  subjectStats(activeSubject).percent
                }%`,
              }}
            />
    ...
    <section className="analytics-page">
      <div className="page-heading">
        <div>
          <h2>Analytics</h2>
          <p>
            Detailed insights into your preparation.
          </p>
        </div>
    ...
    <section className="single-page">
      <div className="page-heading">
        <div>
          <h2>Activity</h2>
          <p>
            A history of your completed study milestones.
          </p>
        </div>
      </div>
      ...
      <section className="panel activity-full">
        {activities.length ? (
          ...
          <div className="empty">
            ...
            <p>
              Mark a chapter, revision, or test
...
function ComingSoon({
  ...
  return (
    <section className="coming-soon panel">
      ...
      <p>
        This section is ready for the next build
        phase. The dashboard and chapter tracker
...
function RecentRow({
  ...
  const meta =
    subjectMeta[item.subject as SubjectName];

  const stage = stages.find(
    (itemStage) =>
      itemStage.key === item.stage
  );
  ...
  return (
    <div className="recent-row">
      ...
      <span className="recent-copy">
        ...
        <small>
          {stageCopy[item.stage]}
        </small>
      </span>

      <span
        className={`activity-status ${item.stage}`}
      >
        {stage?.short}
      </span>
